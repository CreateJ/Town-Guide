 ...
 * name:'router-name'             the name is used by <keep-alive> q (must set!!!)
 * meta : {
...
export const constantRoutes = [
  ...
  },
  {
    ...
    component: Layout,
    redirect: '/scenic',
    meta: { title: '信息管理', icon: 'documentation', affix: false },
    children: [
      {
        path: 'scenic',
        component: () => import('@/views/informationManagement/scenic/index'),
        name: 'scenicList',
        meta: { title: '景区管理', icon: 'documentation', affix: false }
      },
      {
        path: 'scenic-add',
